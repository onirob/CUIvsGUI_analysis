...
# ============================================================
# H1a - Interface -> Mental Workload (ordinal), adjusted for task
#
# PRIMARY HYPOTHESIS:
#   The conversational interface yields lower MWL than the dashboard.
#
# MODEL
#   - cumulative link mixed model (CLMM)
#   - ordinalized MWL outcome
#   - interface_cond = primary predictor
#   - task_complexity = additive nuisance covariate
#   - random intercept for participant
#
# IMPORTANT CHANGE VS OLD VERSION
#   - task_complexity is treatment-coded factor (easy reference)
#   - coefficients are:
#       task_complexitymid
#       task_complexityhard
#     instead of .L / .Q
...
OUT_DIR  <- file.path(SCRIPT_DIR, "results_H1_adjusted")
...
rand_tbl <- extract_random_effect_sd(m_h1, "H1_adjusted")
...
cat("task_complexity is treatment-coded: easy = reference, therefore ottieni mid and hard.\n")